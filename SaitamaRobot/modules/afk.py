...
def no_longer_afk(update: Update, context: CallbackContext):
    ...
    if res:
        ...
        try:
            options = [
                '{} The fool is back', '{} is back!', '{} is now in the chat!',
                '{} Okaeri ', '{} We Miss you Gon!', '{} is finally here! Pay $ 1000 or I'll ban!',
                'Welcome back! {}', 'Where is that idiot?{}?\nIn the chat!'
            ]
...
def check_afk(update, context, user_id, fst_name, userc_id):
    if sql.is_afk(user_id):
        ...
        if not user.reason:
            ...
            if int(userc_id) == int(user_id):
                return
            res = "{} Watashinotomodachi wa hanarete imasu, jama shinaide kudasai! Nazenara.\nReason: <code>{}</code>".format(
